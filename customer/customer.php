...
$sql = "SELECT customer.id, customer.name, customer.gender, customer.phone, customer.email, customer.address, card.code 
        FROM customer
                            ...
                            <table id="datatablesSimple">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td><?= $row['code'] ?></td>
                                        <td>
                                            <a href="edit_customer.php?id=<?= $row['id'] ?>"  class="btn btn-primary">Edit</a>
