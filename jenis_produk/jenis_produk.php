                ...
                <div class="container-fluid px-4">
                    ...
                    <div class="card mb-4">
                        ...
                        <div class="card-body">
                            <table id="datatablesSimple">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td><?= $row['name'] ?></td>
                                        <td>
                                            <a href="edit_jenisproduk.php?id=<?= $row['id'] ?>"  class="btn btn-primary">Edit</a>
                                            <a href="jproduk_delete.php?id=<?= $row['id'] ?>"
                            ...
                            <a href="add_jenisproduk.php" class="btn btn-success">Add new jenis produk</a>
                        </div>
                    </div>
                </div>
            </main>
