...
$sql = "SELECT restock.*, supplier.name as supplier_name FROM restock
                ...
                <div class="container-fluid px-4">
                    ...
                    <div class="card mb-4">
                        ...
                        <div class="card-body">
                            <table id="datatablesSimple">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <a href="edit_restock.php?id=<?= $row['id'] ?>" class="btn btn-primary">Edit</a>
                                            <a href="restock_delete.php?id=<?= $row['id'] ?>"
                            ...
                            <a href="add_restock.php" class="btn btn-success">Add new restock</a>
                        </div>
                    </div>
                </div>
            </main>
